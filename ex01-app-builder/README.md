...
2. At the top, include the necessary headers for input/output, functional objects, and vectors.  Use the standard input/output objects for reading and writing to the console.

3. Create an anonymous namespace and place the following functions inside it:
...
5. Compile and run the program to test its functionality.
```
